...
<body>
	...
	*/
	...
	?>
			...
			<p>The <em>ScriptureEarth.org</em> website is managed by SIL International. SIL’s service with ethnolinguistic minority communities is motivated by the belief that all people are created in the image of God, and that languages and cultures are part of the richness of God's creation.</p>
			...
			<p>Some of the media formats on the website include:
			<ul type="disc">
				<li>video</li>
				<li>audio</li>
		...
		?>
			...
			<div style="text-align: center; margin-top: 30px; margin-bottom: 60px; ">
				<img src='./images/00i-AboutExplanation.jpg' style='height: 60%; width: 60%; ' />
			</div>
		<?php
			break;
		case "CU":
		?>
			...
			<div class='clearfix' style='margin-top: 30px; margin-bottom: 40px; margin-left: 5px; font-size: 120%; '>
				...
				<div class='contacts'>
					To keep ScriptureEarth.org website running donate a one-time or recurring gift to help cover the costs associated with it: <button type='button' onclick="location.href='https://give.sil.org/give/531194/#!/donation/checkout'" style='font-size: 13pt; '>Donate to ScriptureEarth.org</button>
				</div>
			</div>
			...
			<div class='clearfix'>
				<div class='contacts'>
					<strong><img src="./images/VinaIcon.png" alt="Viña Studios" width="30" height="30" /> Viña Studios</strong><br />
		...
		?>
			...
			<p>When you browse this site or contact SIL International via this site, we will not collect personal information about you unless you provide that information voluntarily. If you supply your postal or email address, you will receive only the information for which you provided the address.</p>
