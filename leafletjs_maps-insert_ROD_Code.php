<?php
/*
	This is the third script. Run this AFTER the second script (leafletjs_maps-insert-qqq.php) has run. 

	This script inserts ROD code into leafletjs map builder based on the country(ies) code.
	
	leafletjs_maps-rod.tsv contians: ISO, ROD_Code, ISO_ROD_index, LN_English, country, latitude, and longitude
...
<title>Inserts ROD code ('leafletjs_maps-rod.tsv') into leafletjs map builder.</title>
</head>
<body>
<h1>Start...</h1>
<?php
...
$fileRows = file('leafletjs_maps-rod.tsv', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);	// Open the file in an array
$i=0;
