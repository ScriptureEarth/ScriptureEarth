#!/usr/bin/
    ...
    #
    # When you edit the current file with gedit,
    # you can control the way LangTranUpdate.sh behaves by adding or removing "#"
...
# KeepArchive="yes"
    ...
    #    remove the "#" from one of these following lines, or make your own:
# ArchiveDir="$HOME/NoBackup/LangTranArchive"
# ArchiveDir="$HOME/LangTranArchive"
# ArchiveDir="$Docs/LangTranArchive"
