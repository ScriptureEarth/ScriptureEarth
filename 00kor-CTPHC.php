...
<body>
	...
	switch ($CTPHC) {
		...
		?>
			...
			<p><em>ScriptureEarth.org</em> 웹사이트는 SIL Global이 관리합니다. 소수 민족 언어 공동체와 함께하는 SIL의 섬김은 모든 사람이 하나님의 형상대로 창조되었으며, 언어와 문화는 하나님의 창조에 담긴 풍성함의 일부라는 믿음에서 출발합니다.</p>
		...
		?>
			...
			<div class='clearfix' style='margin-top: 20px; margin-bottom: 40px; margin-left: 20px; font-size: 120%; '>
				<div class='contacts'>
					...
					<img src="./images/sil-icon.jpg" alt="SIL Global" width="32" height="32" /><strong> SIL 인터내셔널</strong><br />
		...
		?>
			...
			<h2>이용약관</h2>
			<p>웹사이트 방문을 환영합니다. 본 웹사이트를 계속 탐색하고 사용하는 경우, 귀하는 개인정보 보호정책과 함께 본 웹사이트와 관련하여 SIL Global과 귀하 사이의 관계를 규율하는 다음 이용 약관을 준수하고 이에 구속되는 데 동의하는 것으로 간주됩니다. 본 이용 약관의 일부에 동의하지 않는 경우 이 웹사이트를 이용할 수 없습니다.</p>
			<p>'SIL Global', '당사'  또는 '우리'라는 용어는 등록 사무소를 7500 West Camp Wisdom Road, Dallas TX, USA에 둔 웹사이트의 소유자를 지칭합니다.</p>
		...
		?>
			...
			<h3>개인정보 수집 및 사용</h3>
			<p>귀하가 이 사이트를 검색하거나 이 사이트를 통해 SIL Global에 연락할 때, 당사는 귀하가 자발적으로 해당 정보를 제공하지 않는 한 귀하에 대한 개인정보를 수집하지 않습니다. 우편 또는 이메일 주소를 제공하는 경우 해당 주소를 제공한 정보만 수신하게 됩니다.</p>
			<p>필요한 경우, 귀하의 요청이나 의견에 대한 응답을 제공하기 위해 개인정보가 SIL Global의 협력 단체에 전달될 수 있습니다.</p>
			<p>본 사이트를 통해 비공개 개인정보(예: 이름, 주소, 이메일 주소 또는 전화번호)를 제공하는 경우, SIL Global은 해당 정보를 수집한 페이지에 명시된 목적으로만 해당 정보를 사용합니다.</p>
			<p>SIL Global은 원치 않는 이메일 또는 “스팸” 이메일을 보내지 않으며 이메일 목록을 제3자에게 판매, 대여 또는 거래하지 않습니다.</p>
			<p>모든 경우에 당사는 관련 법률 및 규정에 따라 요구되는 때에 한하여 정보를 공개합니다.</p>
			<h3>링크</h3>
			<p>스크립처어스에는 다른 웹사이트로 연결되는 링크가 포함되어 있습니다. 이러한 링크는 관련 리소스를 제공합니다. 문서나 사이트에 대한 링크가 SIL Global이 다음 사실을 반드시 동의하거나 보증한다는 것을 의미하지 않습니다.</p>
			<ul>
				<li>해당 문서나 사이트를 제공하는 조직 또는 개인에 관한 보증</li>
				<li>표현된 아이디어에 관한 동의</li>
				<li>콘텐츠의 정확성, 사실성, 적절성 또는 적법성에 관한 보증</li>
			</ul>
			<p>또한 SIL Global은 이러한 웹사이트의 개인정보 보호정책 또는 관행에 대해 책임을 지지 않습니다.</p>
	<?php
			break;
