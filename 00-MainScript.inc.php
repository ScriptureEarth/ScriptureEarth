...
@media only screen and (max-width: 480px) {							/* (max-width: 412px) for Samsung S8+ 2/20/2019 */
	div.colAlt2::before, div.countryAlt2::before, div.moreThanAlt2::before {
...
// here check
					...
					<div>
                        ...
                        if ($Internet) {
                            ...
                            <div class="fb-like"
                                data-href="https://ScriptureEarth.org/<?php echo $Scriptname . "?iso=".$ISO."&rod=".$ROD_Code."&var=".$Variant_Code."; " ?>" 
                                data-width="600px"
