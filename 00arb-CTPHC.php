...
<body>
	...
	switch ($CTPHC) {
		...
		?>
			...
			<p>يُدار موقع اسكريبتشر إيرث <em>ScriptureEarth.org</em> من قِبل مؤسسة خدمة إس آي إل إنترناشونال SIL International. إن الإيمان بأن جميع البشر مخلوقون على صورة الله وأن جميع لغات العالم تمثل جزءًا من غنى خليقته هو العقيدة المُحركة لعمل هيئة SIL بين الأقليات العرقية الناطقة بلغة مختلفة.</p>
		...
		?>
			...
			<h2>بنود وشروط</h2>
			<p>نرحب بزيارتك لموقعنا. بمواصلتك تصفح الموقع واستعماله أنت توافق على التعهد بالالتزام ببنود وشروط الاستعمال التي، جنبًا إلى جنب مع سياسة الخصوصية، تحكم علاقة مؤسسة خدمة SIL International بك كمستخدم لهذا الموقع. في حالة عدم الموافقة على أي جزء من البنود والشروط، فيرجى عدم استخدام الموقع.</p>
			<p>يشير مصطلح SIL International  أو "نحن" إلى مالك الموقع المُسجل مقره في 7500 West Camp Wisdom Road, Dallas TX.</p>
		...
		?>
			...
			<p>عندما تستخدم هذا الموقع الإلكتروني أو تتصل بخدمة SIL International عبر هذا الموقع، لن نجمع معلومات شخصية عنك ما لم تشارك هذه المعلومات طواعية. فإن أدخلت عنوانك البريدي أو عنوان البريد الإلكتروني، سنقتصر في استقبالنا على المعلومات التي أدخلت العنوان من أجلها.</p>
			<p>في حالة الطلب يجوز إرسال المعلومات الشخصية إلى مؤسسات خدمة شريكة لـ SIL International  بغرض الإجابة على طلب أو تعليقات منك كمستخدم.</p>
			<p>إذا قمت بمشاركة معلومات شخصية غير عامة (مثل الاسم، أو العنوان، أو البريد الإلكتروني، رقم الهاتف) عبر هذا الموقع، فإن استخدام SIL International  لهذه المعلومات سيقتصر على الغرض المذكور على الصفحة التي تم إدخال المعلومات عليها.</p>
			<p>لا ترسل SIL International  أي رسائل بريد إلكتروني غير مرغوب فيها أو "تطفلية" كما أنها لا تبيع أو تؤجر أو تتبادل مع أطراف أخرى قوائم البريد الإلكتروني.</p>
			...
			<p>يحتوي ScriptureEarth على روابط بمواقع إلكترونية أخرى، تزودك هذه الروابط بمصادر ذات صلة. ولكن وجود رابط بموقع أو وثيقة لا يعني بالضرورة أن مؤسسة SIL International:</p>
			<ul>
			...
			<p>كما أن SIL International  تخلي مسئوليتها عن سياسات الخصوصية أو ممارساتها في تلك المواقع الأخرى.</p>
	<?php
			break;
