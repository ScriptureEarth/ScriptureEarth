...
elseif ($number == '3b') {                      // type = apk            INSERT
    // APKINSERT(url, projectName, projectDescription, idx, iso, rod, variant, add_index)
...
elseif ($number == '4b') {                      // type = ios            INSERT
    // iosINSERT(url, projectName, projectDescription, idx, iso, rod, variant, add_index)
...
elseif ($number == '5b') {                      // type = google play store    INSERT
    // GPSINSERT(url, projectName, projectDescription, idx, iso, rod, variant, add_index)
