...
// Usage: "00-DownloadStudy.php"+"?T=NT&st="+st+"&iso="+iso+"&ROD_Code="+ROD_Code+"&BookFilename="+BookFilename  
...
$ScriptFilename = '00-DownloadStudy.php';
...
//  $desired_extension = 'ot,ont,nt';							// extensions we're looking for (ot, ont, nt)
