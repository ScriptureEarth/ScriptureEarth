 ...
 *
 * 			There no statements in "_js/CMS_events.js" (8/2020) in "Submit{Add|Edit]Confirm.php".
 *
...
document.getElementById('addEmail').addEventListener('click', function() { addRowToTableEmail(); });

document.getElementById('removeEmail').addEventListener('click', function() { removeRowFromTable('tableEmail'); });
