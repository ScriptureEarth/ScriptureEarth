...
<script src="../_js/SpecificLanguage.js" type="text/javascript" language="javascript"></script>
<script src="../_js/00-SpecificLanguage.js" type='text/javascript' language='javascript1.2'></script>
<style type="text/css">
body {
...
<img src='../images/00i-top_header.jpg' style='position: relative; top: 0px; z-index: 1; width: 50%;' />
</div>

<?php
// get $ISO_ROD_index
// get st
// get $SpecificCountry = English, Spanaish, etc.
// get $Scriptname = 00i_Scripture_Index.php, etc.
// get $MajorCountryAbbr = en, es, etc.
...
if (isset($_GET["SpecificCountry"])) {					// Engish, Spainish, etc.
	$SpecificCountry = $_GET["SpecificCountry"];
	$counterName = $SpecificCountry;
}
else {
	 die('Specific country is missing. Hack!');
}
...
if (isset($_GET["MajorCountryAbbr"])) {
	$MajorCountryAbbr = $_GET["MajorCountryAbbr"];
}
else {
	 die('Major Language ID is missing. Hack!');
}
...
<div id='SpecLang' style='margin-top: 0px; color: black; '><br />
...
$country = '<a href="./00_CountryTable.inc.php?sortby=country&name=' . $ISO_countries . '">' . $country . '</a>';
while ($r_ISO_countries = $result_ISO_countries->fetch_array()) {
	$country = $country . ', <a href="./00_CountryTable.inc.php?sortby=country&name=' . trim($r_ISO_countries["ISO_countries"]) . '">' . trim($r_ISO_countries["$countryTemp"]) . '</a>';			// name of the country in the language version
}
...
?>
<table id='individualLanguage' style='text-align: center; margin-left: auto; margin-rigth: auto; color: white; width: 80%; '>
<?php
/*
	*************************************************************************************************************
		interested?
...
if ($SILlink && $Internet) {
	...
	?>
	<tr style='margin: 0; padding: 0; color: white; '>
		<td style='width: 45px; '>
			<?php
		...
		echo "</td>";
		echo "<td>";
			echo "<a href='$URL' title='".translate('Check SIL.org', $st, 'sys')."' target='_blank'><span class='lineAction'>".translate('Check SIL.org', $st, 'sys')."</span> ".translate('for resources in this language', $st, 'sys')."</a>";
			//if ($company_title != "" && $company_title != NULL) {
			 //   echo "$company_title: ";
			//}
			//echo "SIL</a>";
