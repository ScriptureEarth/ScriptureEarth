...
/*
	*************************************************************************************************************
		Is it the Synchronized text and audio (Scripture App Builder (SAB) HTML?
	*************************************************************************************************************
*/
                    ...
                    <div id='OTSABSelects' style='display: inline; '>
                        ...
                        foreach ($OT_array[OT_EngBook] as $a) {									// display the OT books in the MAJOR language!
                            ...
                            if ($result_array && $num_array > 0) {
                                ...
                                echo "<option id='OT_SAB_Book_$OT_SAB_a_index' name='OT_SAB_Book_$OT_SAB_a_index' class='selectOption' value='$OT_Book_Chapter_HTML'>$a</option>";
                            }
                            $OT_SAB_a_index++;
                        }
                        echo "</select>";
