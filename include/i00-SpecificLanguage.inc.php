				...
				*/
				...
				if ($result2 && $num > 0) {
					...
					<tr>
						<td>
							<?php
							echo "<a href='#' onclick='SAB_OT()'><img class='iconActions' ";
							if ($SAB & 2) {
						...
						echo "<td>";
							...
							<div class='SABReadListen'>
								<?php
								echo "<a href='#' onclick='SAB_OT()'><span ";
								if ($SAB & 2) {
								...
								<div id='OTSABSelects' style='display: inline; '>
									...
									echo "<select id='OT_SAB_Book' name='OT_SAB_Book' class='selectOption' onchange='SAB_OT()'>";
...
//echo '<br />'.$num.'<br />';
				if ($result2 && $num > 0) {
					...
					<tr>
						<td>
							<?php
							echo "<div class='linePointer' onclick='SAB_NT()'><img class='iconActions' ";
							if ($SAB & 1) {
								echo "src='../images/SAB-readListen-icon.png' alt='".translate('Text with audio', $st, 'sys')."' title='".translate('Text with audio', $st, 'sys')."'";
								$SynchronizedTextAndAudio = 1;
							}
						...
						echo "<td>";
							...
							<div class='SABReadListen'>
								<?php
								echo "<div class='linePointer' onclick='SAB_NT()'><span ";
								if ($SAB & 1) {
								...
								<div id='NTSABSelects' style='display: inline; '>
									...
									echo "<select id='NT_SAB_Book' name='NT_SAB_Book' class='selectOption' onchange='SAB_NT()'>";
									echo "<option>".translate('Choose One...', $st, 'sys')."</option>";
				...
				*/
				...
				echo '<tr>';
					echo '<td>';
						echo "<a href='#' onclick='SAB_Scriptoria_Index()'><img class='iconActions' ";
						echo "src='../images/SAB-readListen-icon.png' alt='".translate('Read/Listen/View', $st, 'sys')."' title='".translate('Read/Listen/View', $st, 'sys')."'";
						echo "/></a>";
					echo '</td>';
					echo '<td>';
						echo "<a href='#' onclick='SAB_Scriptoria_Index()'><span class='lineAction'>" . translate('Read/Listen/View', $st, 'sys') . "</span></a>: ";
						echo "<form name='form_SAB_Books' id='form_SAB_Books' style='display: inline; '>";
						echo "<select id='SAB_Book' name='SAB_Book' class='selectOption' onchange='SAB_Scriptoria()'>";
						echo "<option>".translate('Choose One...', $st, 'sys')."</option>";
...
<script>
    function SAB_OT() {
        ...
        if (y[x].text != "<?php echo translate('Choose One...', $st, 'sys'); ?>") {
        	GoSAB("<?php echo $ISO; ?>", document.form_OT_SAB_Books.OT_SAB_Book.value, "<?php echo $subfolder; ?>");
		}
    }
	function SAB_NT() {
        ...
        if (y[x].text != "<?php echo translate('Choose One...', $st, 'sys'); ?>") {
            GoSAB("<?php echo $ISO; ?>", document.form_NT_SAB_Books.NT_SAB_Book.value, "<?php echo $subfolder; ?>");
        }
    }
    function SAB_Scriptoria_Index() {
        var x = document.getElementById("SAB_Book").selectedIndex;
        var y = document.getElementById("SAB_Book").options;
		//if (y[x].text != "< ?php echo translate('Choose One...', $st, 'sys'); ?>") {
			window.open("data/<?php echo $ISO . "/" . $subfolder; ?>index.html", "SABPage");
		//}
	}
    function SAB_Scriptoria() {
        var x = document.getElementById("SAB_Book").selectedIndex;
        var y = document.getElementById("SAB_Book").options;
        if (y[x].text != "<?php echo translate('Choose One...', $st, 'sys'); ?>") {
			GoSAB_subfolder("<?php echo $ISO; ?>", document.form_SAB_Books.SAB_Book.value, "<?php echo $subfolder; ?>");
		}
		else {
			window.open("data/<?php echo $ISO . "/" . $subfolder; ?>index.html", "SABPage");
		}
