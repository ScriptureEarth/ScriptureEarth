...
/*
	*************************************************************************************************************
		Is it the Scripture App Builder (SAB) HTML?
	*************************************************************************************************************
*/
// The cooments are for the implemenation of the chapters. Loren and Bill decided to delete the chapters.
	...
	if ($result2 && $num > 0) {
		...
		<tr>
			<td>
				<?php
				$OT_SAB_Book = array();
				$OT_SAB_Book_Chapter = array();
				$OT_SAB_a_index = 0;
				echo "<a href='#' onclick='GoSAB(\"$ISO\", document.form_OT_SAB_Books.OT_SAB_Book.value)'><img class='iconActions' src='images/SAB-readListen-icon.png' alt='".translate('Read and Listen', $st, 'sys')."' title='".translate('Read and Listen', $st, 'sys')."' />";
				echo "</a>";
			echo "</td>";
			echo "<td>";
				?>
				...
				<?php
				echo "<a href='#' onclick='GoSAB(\"$ISO\", document.form_OT_SAB_Books.OT_SAB_Book.value)'><span class='lineAction'>" . translate('Synchronized text and audio', $st, 'sys') . "</span></a>: ";
				?>
				...
				foreach ($OT_array[OT_EngBook] as $a) {											// display the OT books in the MAJOR language!
					$query_array="SELECT * FROM SAB WHERE ISO_ROD_index = '$ISO_ROD_index' AND SAB_Book = '".($OT_SAB_a_index+1)."' AND (Book_Chapter_HTML is not null AND trim(Book_Chapter_HTML) <> '') ORDER BY SAB_Chapter ASC";
					...
					if ($result_array && $num_array > 0) {
						...
						echo "<option id='OT_SAB_Book_$a_index' name='OT_SAB_Book_$a_index' class='selectOption' value='$OT_Book_Chapter_HTML'>$a</option>";
					}
					$OT_SAB_a_index++;
				}
				echo "</select>";
	...
	if ($result2 && $num > 0) {
		...
		<tr>
			<td>
				<?php
				$NT_SAB_Book = array();
				$NT_SAB_Book_Chapter = array();
				$NT_SAB_a_index = 0;
//				echo "<a href='#' onclick='GoSAB(document.form_NT_SAB_Chapters.NT_SAB_Chapters)'><img class='iconActions' src='images/SAB-readListen-icon.png' alt='".translate('Read and Listen', $st, 'sys')."' title='".translate('Read and Listen', $st, 'sys')."' />";
				echo "<a href='#' onclick='GoSAB(\"$ISO\", document.form_NT_SAB_Books.NT_SAB_Book.value)'><img class='iconActions' src='images/SAB-readListen-icon.png' alt='".translate('Read and Listen', $st, 'sys')."' title='".translate('Read and Listen', $st, 'sys')."' />";
				echo "</a>";
			echo "</td>";
			echo "<td>";
				?>
				<div class='SABReadListen'>
				<?php
//				echo "<a href='#' onclick='GoSAB(document.form_NT_SAB_Chapters.NT_SAB_Chapters)'><span class='lineAction'>" . translate('Synchronized text and audio', $st, 'sys') . "</span></a>: ";
				echo "<a href='#' onclick='GoSAB(\"$ISO\", document.form_NT_SAB_Books.NT_SAB_Book.value)'><span class='lineAction'>" . translate('Synchronized text and audio', $st, 'sys') . "</span></a>: ";
				?>
				...
				*/
				// Get and display Books
//				echo "<select id='NT_SAB_Book' name='NT_SAB_Book' class='selectOption' onchange='SABChangeChapters(\"NT\", \"$ISO\", \"ROD_Code\", this.options[this.selectedIndex].value); GoSAB(document.form_NT_SAB_Chapters.NT_SAB_Chapters)'>";
				...
				foreach ($NT_array[NT_EngBook] as $a) {											// display the NT books in the MAJOR language!
					$query_array="SELECT * FROM SAB WHERE ISO_ROD_index = '$ISO_ROD_index' AND SAB_Book = '".($NT_SAB_a_index+41)."' AND (Book_Chapter_HTML is not null AND trim(Book_Chapter_HTML) <> '') ORDER BY SAB_Chapter ASC";
					$result_array=$db->query($query_array);
					$num_array=$result_array->num_rows;
					if ($result_array && $num_array > 0) {
						$NT_SAB_Book[] = $NT_SAB_a_index;
//						$j=(string)$NT_SAB_a_index;
...
/*							if (!empty($NT_Book_Chapter_HTML)) {
								$NT_SAB_Chapter = trim($r_array['SAB_Chapter']);
								$NT_SAB_Book_Chapter[$NT_SAB_a_index][] = $NT_SAB_Chapter;
								$j = $j . "," . $NT_SAB_Chapter . "," . $NT_Book_Chapter_HTML;
							}
*/
//						}
//						echo "<option id='NT_SAB_Book_$a_index' name='NT_SAB_Book_$a_index' class='selectOption' value='$j'>$a</option>";
						echo "<option id='NT_SAB_Book_$NT_SAB_a_index' name='NT_SAB_Book_$NT_SAB_a_index' class='selectOption' value='$NT_Book_Chapter_HTML'>$a</option>";
					}
					$NT_SAB_a_index++;
				}
				echo "</select>";
				...
				?>
<!--				<form name='form_NT_SAB_Chapters' id='form_NT_SAB_Chapters' style='display: inline; '>
				<select name='NT_SAB_Chapters' id='NT_SAB_Chapters' class='selectOption' onchange='GoSAB(document.form_NT_SAB_Chapters.NT_SAB_Chapters)'>
				< ?php
				$a_index = 0;
				foreach ($NT_array[NT_EngBook] as $a) {											// display the NT books in the MAJOR language!
					$query_array="SELECT * FROM SAB WHERE ISO_ROD_index = '$ISO_ROD_index' AND SAB_Book = '".($a_index+41)."' AND (Book_Chapter_HTML is not null AND trim(Book_Chapter_HTML) <> '') ORDER BY SAB_Chapter ASC";
					$result_array=$db->query($query_array);
					$num_array=$result_array->num_rows;
					if ($result_array && $num_array > 0) {
						$i=0;
						while ($r_array = $result_array->fetch_array()) {						// display the chapters
							$NT_Book_Chapter_HTML = trim($r_array['Book_Chapter_HTML']);
							if (!empty($NT_Book_Chapter_HTML)) {
								$NT_SAB_Chapter = trim($r_array['SAB_Chapter']);
								echo "<option id='NT_SAB_Chapters_$i' name='NT_SAB_Chapters_$i' class='selectOption' value='$a^data/$ISO/sab/$NT_Book_Chapter_HTML'>$NT_SAB_Chapter</option>";
							}
							$i++;
						}
						break;
...
/*
	...
	*************************************************************************************************************
*/
$CellPhone=trim($rowSM['CellPhone']);
	/*
	GoBible (Java)
	MySword (Android)
	iPhone
	...
	if ($result2) {
		//if ($result2->num_rows >= 1) {
			...
			while ($r2 = $result2->fetch_array()) {
				$Cell_Phone_Title=trim($r2['Cell_Phone_Title']);
				$Cell_Phone_File=trim($r2['Cell_Phone_File']);
				/*if ($Cell_Phone_Title == 'Android App') {					I don't know why I did this?? (2/10/16)
...
/*
	...
	*************************************************************************************************************
*/
$other_titles=$rowSM['other_titles'];
if ($other_titles) {
...
if ($links) {
		...
		if ($Internet) {
			...
			while ($r2 = $result2->fetch_array()) {
				...
				<tr>
					<td style='width: 45px; '>
						<?php
						echo "<a href='$URL' title='".translate('Link to $company.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/app-icon.jpg' alt='".translate('Google Play', $st, 'sys')."' title='".translate('Google Play', $st, 'sys')."' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
	...
	$query="SELECT * FROM links WHERE ISO_ROD_index = '$ISO_ROD_index' AND map = 0 AND buy = 0 AND BibleIs = 0 AND YouVersion = 0 AND `Bibles_org` = 0 AND `GooglePlay` = 0";
	$result2=$db->query($query);
	if ($result2) {
		if ($Internet) {
			//$num=mysql_num_rows($result2);
...
if ($PlaylistVideo && $Internet) {
	...
	while ($r_Playlist = $result_Playlist->fetch_array()) {
		...
		<tr>
			<td style='width: 45px; '>
				<?php
				echo "<a href='#' title='".translate('View', $st, 'sys')." $PlaylistVideoTitle' onClick='PlaylistVideo(orgVideoPixels_$z, \"PlaylistVideoNow_$z\")'><img class='iconActions' src='images/youtube-icon.jpg' alt='".translate('View', $st, 'sys')."' title='".translate('View', $st, 'sys')."' /></a>";
				?>
			</td>
			<td>
				<?php
            ...
            <td>
				<?php
					if ($bs != 0) {
						...
						echo "<div style='text-align: center; '><a href='#' style='text-align: center; ' title='".$VideoName."' onClick='window.open(\"".$VideoConvertWithTab[3]."\",\"_blank\")'><img src='data/".$ISO."/video/".$VideoConvertWithTab[2]."' alt='".translate('View', $st, 'sys')." ".$VideoName."' title='".translate('View', $st, 'sys')." ".$VideoName."' /></a></div>";
...
if ($eBible && $Internet) {
	...
	if ($num2 > 0) {
		...
		<tr>
			<td style='width: 45px; '>
				<?php
				echo "<a href='#' title='".translate('Scripture Resources from eBible.org', $st, 'sys')."' onclick='eBibleClick()'><img class='iconActions' src='images/links-icon.jpg' alt='".translate('Scripture Resources from eBible.org', $st, 'sys')."' title='".translate('Scripture Resources from eBible.org', $st, 'sys')."' />";
				echo "</a>";
			echo "</td>";
			echo "<td>";
