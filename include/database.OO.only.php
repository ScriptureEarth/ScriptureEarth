...
//echo 'Z ' . $this->num_members . ' Z<br />';
         $q = "SELECT * FROM ".TBL_USERS;
//echo 'C ' . TBL_USERS . ' C<br />';
         $result = $this->connection->query($q);							/// THIS IS THE PROBLEM!
		 if (!$result) {
			$this->num_members = 0;
		 }
		 else {
...
//echo 'C ' . $result->num_rows . ' C<br />';
//echo 'C ' . $this->num_members . ' C<br />';
      }
...
//echo 'C ' . $result->num_rows . ' C<br />';
//echo 'C ' . $this->num_active_users . ' C<br />';
   }
