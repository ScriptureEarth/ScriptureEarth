    ...
    */
    ...
    echo '<div id="CT">';
        while ($i < $num) {
            ...
            echo "<div class='countrySecond' style='background-color: rgba(".$color."); '>";
				// language
                echo "<div class='pick countryLN2' onclick='location.href=\"./".$Scriptname."?sortby=lang&name=$ISO&ISO_ROD_index=$ISO_ROD_index\"'>$LN";
                $VD = '';
                ...
                echo "<div class='pick countryCode2' onclick='location.href=\"./".$Scriptname."?sortby=lang&name=$ISO&ISO_ROD_index=$ISO_ROD_index\"'>$ISO</div>";
                ...
                if ($result_alt) {
                    ...
                    echo "<div class='pick countryAlt2' onclick='location.href=\"./".$Scriptname."?sortby=lang&name=$ISO&ISO_ROD_index=$ISO_ROD_index\"'>";
					$alt_item = '';
                    $i_alt=0;
