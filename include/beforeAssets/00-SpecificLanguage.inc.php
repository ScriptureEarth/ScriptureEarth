...
echo $c . ') would have UPDATE CellPhone<br />';
			...
			<tr>
				<td style='width: 45px; '>
					<?php
					echo "<div class='linePointer' title='" . translate('Download the Scripture Earth app for iOS', $st, 'sys') . "' onclick='CellPhoneModule(\"$st\", \"$ISO\", \"$ROD_Code\", \"https://apps.apple.com/us/app/scripture-earth/id15800889704\")'><img class='iconActions' src='../images/iOS_App.jpg' alt='".translate('Cell Phone', $st, 'sys')."' title='".translate('Cell Phone', $st, 'sys')."' />";
				echo "</td>";
				echo "<td>";
					echo "<div class='linePointer' title='" . translate('Download the Scripture Earth app for iOS', $st, 'sys') . "' onclick='CellPhoneModule(\"$st\", \"$ISO\", \"$ROD_Code\", \"https://apps.apple.com/us/app/scripture-earth/id15800889704\")'><span class='lineAction'>" . translate('Download', $st, 'sys') . "</span> " . translate('the Scripture Earth app for iOS', $st, 'sys');
				echo ' ' . $optional . '</div>';
					?>
				</td>
			</tr>
...
/*
	*************************************************************************************************************
		Is it a cell phone module (apart from the Android App and iOS)?
	*************************************************************************************************************
*/
	/*
		GoBible (Java)
		...
		while ($r2 = $result2->fetch_array(MYSQLI_ASSOC)) {
			...
			<tr>
				<td style='width: 45px; '>
					...
					elseif ($Cell_Phone_Title == 'iPhone') {
