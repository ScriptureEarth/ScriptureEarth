	...
	if (isset($result2)) {
		if (mysql_num_rows($result2) >= 1) {
            ...
            <tr>
				<td>
					<?php
					echo "<a href='$URL' target='_blank'><img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' width='45' height='40' />";
					echo "</a>";
				echo "</td>";
				echo "<td>";
        		...
        		<tr>
					<td>
						...
						if ($Item == 'B') {
							...
							echo "<a href='data/$ISO/PDF/$whole_Bible' title='".translate('Read the Bible.', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' width='45' height='40' />";
							echo "</a>";
							echo "</td>";
							echo "<td>";
							echo "<a href='data/$ISO/PDF/$whole_Bible' title='".translate('Read the Bible.', $st, 'sys')."' target='_blank'><span class='lineAction'>".translate('Read', $st, 'sys')."</span> ".translate('the Bible', $st, 'sys')."</a>";
						}
						else {
							$complete_Scripture=trim(mysql_result($result_SB,$i_SB,"Scripture_Bible_Filename"));
							echo "<a href='data/$ISO/PDF/$complete_Scripture' title='".translate('Read a Scripture portion.', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' width='45' height='40' />";
							echo "</a>";
							echo "</td>";
							echo "<td>";
							echo "<a href='data/$ISO/PDF/$complete_Scripture' title='".translate('Read a Scripture portion.', $st, 'sys')."' target='_blank'><span class='lineAction'>".translate('Read', $st, 'sys')."</span> ".translate('a Scripture portion', $st, 'sys')."</a>";
						}
						?>
					</td>
				</tr>
		...
		if ($OT_PDF > 0) {
			...
			if ($num > 0) {
                ...
                <tr>
					<td>
						<?php
						echo "<a href='data/$ISO/PDF/$OT_PDF_Filename' title='".translate('Read the Old Testament.', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' width='45' height='40' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
						echo "<a href='data/$ISO/PDF/$OT_PDF_Filename' title='".translate('Read the Old Testament.', $st, 'sys')."' target='_blank'><span class='lineAction'>".translate('Read', $st, 'sys')."</span> ".translate('the Old Testament', $st, 'sys')."</a>";
						?>
					</td>
				</tr>
				<?php
			...
			if ($num > 0) {
				...
				<tr>
					<td>
						<?php
						echo "<img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' width='45' height='40' />";
					echo "</td>";
					echo "<td>";
						echo "<form name='PDF_OT'>";
						...
						foreach ($OT_array[OT_EngBook] as $a) {															// there is/are book(s)
							...
							if ($num > 0) {
								...
								if (!empty($OT_PDF_Filename)) {
									echo "<option class='selectOption' value='data/$ISO/PDF/$OT_PDF_Filename'>$a</option>";
								}
							}
							$a_index++;
						}
		...
		if ($NT_PDF > 0) {
			...
			if ($num > 0) {
                ...
                <tr>
					<td>
						<?php
						echo "<a href='data/$ISO/PDF/$NT_PDF_Filename' title='".translate('Read the New Testament.', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' width='45' height='40' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
						echo "<a href='data/$ISO/PDF/$NT_PDF_Filename' title='".translate('Read the New Testament.', $st, 'sys')."' target='_blank'><span class='lineAction'>".translate('Read', $st, 'sys')."</span> ".translate('the New Testament', $st, 'sys')."</a>";
						?>
					</td>
				</tr>
				<?php
		...
		*/
		if ($FCBH > 0) {
			...
			*/
            ...
            echo "<tr>";
            echo '<td>';
			echo "<a href='#' title='".translate('Listen with Faith Comes By Hearing widget.', $st, 'sys')."' onclick='FCBHClick(o.value)'><img style='border-style: none; ' align='center' src='images/listen-icon.jpg' alt='".translate('Listen', $st, 'sys')."' title='".translate('Listen', $st, 'sys')."' width='45' height='40' />";
			echo "</a>";
			echo "</td>";
			echo "<td>";
...
if ($NT_Audio > 0 || $OT_Audio > 0 || $PDF_NT > 0 || $PDF_OT > 0 || $SB_PDF > 0) {							// if it is a 1 then
	if ($SB_PDF > 0) {
		...
		while ($i_SB < $SB_PDF) {
			...
			if ($Item == 'B') {
				$whole_Bible=trim(mysql_result($result_SB,$i_SB,"Scripture_Bible_Filename"));
				echo "<a href='#' title='".translate('Download the Bible.', $st, 'sys')."' onclick='BPDF(\"$st\", \"$ISO\", \"$ROD_Code\", \"$whole_Bible\")'><img class='iconActions' align='center' src='images/download-icon.jpg' alt='".translate('Download', $st, 'sys')."' title='".translate('Download', $st, 'sys')."' width='45' height='40' />";
				echo "</a>";
				echo "</td>";
				echo "<td>";
				...
				$complete_Scripture=trim(mysql_result($result_SB,$i_SB,"Scripture_Bible_Filename"));
				echo "<a href='#' title='".translate('Download Scripture text.', $st, 'sys')."' onclick='SPDF(\"$st\", \"$ISO\",\"$ROD_Code\", \"$complete_Scripture\")'><img class='iconActions' align='center' src='images/download-icon.jpg' alt='".translate('Download', $st, 'sys')."' title='".translate('Download', $st, 'sys')."' width='45' height='40' />";
				echo "</a>";
				echo "</td>";
				echo "<td>";
	...
	if ($PDF_OT > 0) {
		...
		<form>
			<tr style='margin-top: -2px; '>
				<td style='width: 45px; '>
					<?php
					echo "<a href='#' title='".translate('Download the PDF Old Testament.', $st, 'sys')."' onclick='OTPDF(\"$st\", \"$ISO\",\"$ROD_Code\", \"$OT_PDF_Filename\")'><img class='iconActions' align='center' src='images/download-icon.jpg' alt='".translate('Download', $st, 'sys')."' title='".translate('Download', $st, 'sys')."' width='45' height='40' />";
					echo "</a>";
				echo "</td>";
				echo "<td>";
	...
	if ($OT_Audio > 0) {
		...
		<form>
			...
			<tr style='margin-top: -2px; '>
				<td style='width: 45px; '>
					<?php
					echo "<a href='#' title='".translate('Download the audio Old Testament files.', $st, 'sys')."' onclick='OTTableClick()'><img class='iconActions' align='center' src='images/download-icon.jpg' alt='".translate('Download', $st, 'sys')."' title='".translate('Download', $st, 'sys')."' width='45' height='40' />";
					echo "</a>";
				echo "</td>";
				echo "<td>";
	...
	if ($PDF_NT > 0) {
		...
		<form>
			<tr style='margin-top: -2px; '>
				<td style='width: 45px; '>
					<?php
					echo "<a href='#' title='".translate('Download the New Testament.', $st, 'sys')."' onclick='NTPDF(\"$st\", \"$ISO\", \"$ROD_Code\", \"$NT_PDF_Filename\")'><img class='iconActions' align='center' src='images/download-icon.jpg' alt='".translate('Download', $st, 'sys')."' title='".translate('Download', $st, 'sys')."' width='45' height='40' />";
					echo "</a>";
				echo "</td>";
				echo "<td>";
	...
	if ($NT_Audio > 0) {
		?>
			...
			<tr style='margin-top: -2px; '>
				<td style='width: 45px; '>
					<?php
					echo "<a href='#' title='".translate('Download the audio New Testament files.', $st, 'sys')."' onclick='NTTableClick()'><img class='iconActions' align='center' src='images/download-icon.jpg' alt='".translate('Download', $st, 'sys')."' title='".translate('Download', $st, 'sys')."' width='45' height='40' />";
					echo "</a>";
				echo "</td>";
				echo "<td>";
	...
	if (isset($result2)) {
		if (mysql_num_rows($result2) >= 1) {
			...
			<tr>
				<td style='width: 45px; '>
					<?php
					echo "<a href='$URL' target='_blank'><img class='iconActions' align='center' src='images/CellPhoneIcon.png' alt='".translate('Cell Phone', $st, 'sys')."' title='".translate('Cell Phone', $st, 'sys')."' width='45' height='40' />";
					echo "</a>";
				echo "</td>";
				echo "<td>";
		...
		if (mysql_num_rows($result2) >= 1) {
			...
			while ($i < $num) {
				...
				<tr>
					<td style='width: 45px; '>
						<?php
						echo "<a href='#' alt='" . translate('Download the cell phone module for', $st, 'sys') . "$Cell_Phone_Title' onclick='CellPhoneModule(\"$st\", \"$ISO\", \"$ROD_Code\", \"$Cell_Phone_File\")'><img class='iconActions' align='center' src='images/CellPhoneIcon.png' alt='".translate('Cell Phone', $st, 'sys')."' title='".translate('Cell Phone', $st, 'sys')."' width='45' height='40' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
		...
		if (mysql_num_rows($result2) >= 1) {
			...
			while ($i < $num) {
                ...
                <td style='width: 45px; '>
                    ...
                    echo "<img class='iconActions' align='center' src='images/watch-icon.jpg' alt='".translate('Watch', $st, 'sys')."' title='".translate('Watch', $st, 'sys')."' width='45' height='40' />";
                    ?>
                    </a>
                </td>
                <td>
	...
	if (isset($result2)) {
		if (mysql_num_rows($result2) >= 1) {
			...
			<tr>
				<td style='width: 45px; '>
					<?php
					echo "<a href='$URL' target='_blank'><img class='iconActions' align='center' src='images/study-icon.jpg' alt='".translate('Study', $st, 'sys')."' title='".translate('Study', $st, 'sys')."' width='45' height='40' />";
					echo "</a>";
				echo "</td>";
				echo "<td>";
...
if ($viewer && (!$YouVersion && !$Biblesorg)) {
	...
	<tr>
		<td style='width: 45px; '>
			<?php
			echo "<a href='./viewer/views.php?iso=$ISO&ROD_Code=$ROD_Code&Variant_Code=$Variant_Code&ROD_Var=$ROD_Var&rtl=$rtl&st=$st' title='".translate('Viewer for $LN', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/study-icon.jpg' alt='".translate('Study', $st, 'sys')."' title='".translate('Study', $st, 'sys')."' width='45' height='40' />";
			echo "</a>";
		echo "</td>";
		echo "<td>";
			...
			while ($i < $num) {
				...
				<tr>
					<td style='width: 45px; '>
						<?php
						if (!empty($other_PDF)) {
							echo "<a href='data/$ISO/PDF/$other_PDF' title='".translate('Read $other_title.', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Books', $st, 'sys')."' title='".translate('Books', $st, 'sys')."' width='45' height='40' />";
							echo "</a>";
							echo "</td>";
							echo "<td>";
							...
							echo "<a href='data/$ISO/audio/$other_audio' title='".translate('Listen to $other_title.', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/read-icon.jpg' alt='".translate('Books', $st, 'sys')."' title='".translate('Books', $st, 'sys')."' width='45' height='40' />";
							echo "</a>";
							echo "</td>";
							echo "<td>";
		...
		if (mysql_num_rows($result2) >= 1) {
			...
			while ($i < $num) {
				...
				<tr>
					<td style='width: 45px; '>
						<?php
						echo "<a href='$URL' title='".translate('Buy from $organization.', $st, 'sys')."' target='_blank'><img class='iconActions' align='center' src='images/buy-icon.jpg' alt='".translate('Buy', $st, 'sys')."' title='".translate('Buy', $st, 'sys')."' width='45' height='40' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
		...
		if (mysql_num_rows($result2) >= 1) {
			...
			while ($i < $num) {
				...
				<tr>
					<td style='width: 45px; '>
						<?php
						echo "<a href='$URL' title='".translate('Link to $company.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/buy-icon.jpg' alt='".translate('Buy', $st, 'sys')."' title='".translate('Buy', $st, 'sys')."' width='45' height='40' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
		...
		if (mysql_num_rows($result2) >= 1) {
			...
			while ($i < $num) {
				...
				<tr>
					<td style='width: 45px; '>
						<?php
						echo "<a href='$URL' title='".translate('Link to $company.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/links-icon.jpg' alt='".translate('Link', $st, 'sys')."' title='".translate('Link', $st, 'sys')."' width='45' height='40' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
						echo "<a href='$URL' title='".translate('Link to $company.', $st, 'sys')."' target='_blank'><span class='lineAction'>".translate('Link', $st, 'sys')."</span> ".translate('to', $st, 'sys')." ";
		...
		if (mysql_num_rows($result2) >= 1) {
			...
			while ($i < $num) {
				...
				<tr>
					<td style='width: 45px; '>
						<?php
						echo "<a href='$URL' title='".translate('Link to $company.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/globe-icon.png' alt='".translate('Map', $st, 'sys')."' title='".translate('Map', $st, 'sys')."' width='45' height='40' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
						echo "<a href='$URL' title='".translate('Link to $company.', $st, 'sys')."' target='_blank'><span class='lineAction'>".translate('Link', $st, 'sys')."</span> ".translate('to', $st, 'sys')." ";
