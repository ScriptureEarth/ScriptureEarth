        		...
        		<tr>
					<td>
						...
						if ($Item == 'B') {
							...
							echo "<a href='data/$ISO/PDF/$whole_Bible' title='".translate('Read the Bible.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' />";
							echo "</a>";
							echo "</td>";
							echo "<td>";
							...
							echo "<a href='data/$ISO/PDF/$complete_Scripture' title='".translate('Read a Scripture portion.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' />";
							echo "</a>";
							echo "</td>";
							echo "<td>";
		...
		if ($OT_PDF > 0) {
			...
			if ($num > 0) {
                ...
                <tr>
					<td>
						<?php
						echo "<a href='data/$ISO/PDF/$OT_PDF_Filename' title='".translate('Read the Old Testament.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
		...
		if ($NT_PDF > 0) {
			...
			if ($num > 0) {
                ...
                <tr>
					<td>
						<?php
						echo "<a href='data/$ISO/PDF/$NT_PDF_Filename' title='".translate('Read the New Testament.', $st, 'sys')."' target='_blank'><img class='iconActions' src='images/read-icon.jpg' alt='".translate('Read', $st, 'sys')."' title='".translate('Read', $st, 'sys')."' />";
						echo "</a>";
					echo "</td>";
					echo "<td>";
					...
					<tr>
						...
						foreach ($OT_array[OT_EngBook] as $a) {																// display Eng. NT books
							...
							if ($num_array > 0) {
								...
								?>
								<td width=<?php echo $num_array_col; ?>>
								<?php
								$ZipFile = 0;
								$ii=0;
						...
						for (; $j <= $media_index; $j++) {
							?>
							<td width=<?php echo $num_array_col; ?>>&nbsp;</td>
							<?php
						}
						?>
					</tr>
...
if ($PlaylistVideo && $Internet) {
	...
	for ($z=1; $z <= $num3; $z++) {
		...
		if ($st == "spa") {
			...
			if ($PlaylistVideoTitle == "Acts Video") $PlaylistVideoTitle = "video de Hachos";
		}
				...
				<?php
					if ($bs != 0) {
						...
						if ($st == "spa") {
							...
							if ($VideoName == "Acts Video") $VideoName = "Video de Hachos";
						}
