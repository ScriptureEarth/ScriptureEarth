...
function Counter($c, $display = false) {				// $c = AllCounter or ... counter
	...
	if (preg_match("/^(All|AllML|EnglishML|SpanishML|PortugueseML|DutchML|FrenchML|GermanML|ChineseML|KoreanML|RussianML)_?([A-Z]{2}_[a-z]{3}|[A-Z]{2}|_?[a-z]{3}|)_?Counter/", $c)) {		// => ZZ_zzz or _?zzz
