...
links table - map = 0 AND buy = 0 AND BibleIs = 0 AND YouVersion = 0 AND `Bibles_org` = 0 AND `GooglePlay` = 0 AND `GRN` = 0 AND `email` = 0 AND Kalaam = 0 AND `AppleStore` = 0
	company (text)
    company_title (text)
	URL (https)
...
if ($index== 1) {
    $stmt_links = $db->prepare("SELECT `ISO`, `ROD_Code`, `Variant_Code`, ISO_ROD_index, `company`, `company_title`, `URL` FROM `links` WHERE ISO_ROD_index = ? AND map = 0 AND buy = 0 AND BibleIs = 0 AND YouVersion = 0 AND `Bibles_org` = 0 AND `GooglePlay` = 0 AND `GRN` = 0 AND `email` = 0 AND Kalaam = 0 AND `AppleStore` = 0 ORDER BY `ISO`, `ROD_Code`, `Variant_Code`");
    $stmt_links->bind_param('i', $idx);															// bind parameters for markers
}
else {
	if ($iso == 'ALL') {
		$stmt_links = $db->prepare("SELECT `ISO`, `ROD_Code`, `Variant_Code`, ISO_ROD_index, `company`, `company_title`, `URL` FROM `links` WHERE map = 0 AND buy = 0 AND BibleIs = 0 AND YouVersion = 0 AND `Bibles_org` = 0 AND `GooglePlay` = 0 AND `GRN` = 0 AND `email` = 0 AND Kalaam = 0 AND `AppleStore` = 0 ORDER BY `ISO`, `ROD_Code`, `Variant_Code`");
		//$stmt_links->bind_param();														// bind parameters for markers
	}
	elseif ($rod == 'ALL' && $var == 'ALL') {
		$stmt_links = $db->prepare("SELECT `ISO`, `ROD_Code`, `Variant_Code`, ISO_ROD_index, `company`, `company_title`, `URL` FROM `links` WHERE `ISO` = ? AND map = 0 AND buy = 0 AND BibleIs = 0 AND YouVersion = 0 AND `Bibles_org` = 0 AND `GooglePlay` = 0 AND `GRN` = 0 AND `email` = 0 AND Kalaam = 0 AND `AppleStore` = 0 ORDER BY `ISO`, `ROD_Code`, `Variant_Code`");
		$stmt_links->bind_param('s', $iso);														// bind parameters for markers
	}
	elseif ($rod == 'ALL') {
		$stmt_links = $db->prepare("SELECT `ISO`, `ROD_Code`, `Variant_Code`, ISO_ROD_index, `company`, `company_title`, `URL` FROM `links` WHERE `ISO` = ? AND `Variant_Code` = ? AND map = 0 AND buy = 0 AND BibleIs = 0 AND YouVersion = 0 AND `Bibles_org` = 0 AND `GooglePlay` = 0 AND `GRN` = 0 AND `email` = 0 AND Kalaam = 0 AND `AppleStore` = 0 ORDER BY `ISO`, `ROD_Code`, `Variant_Code`");
