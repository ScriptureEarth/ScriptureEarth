-- Host: localhost:3306
-- Generation Time: Aug 02, 2024 at 04:04 PM
...
CREATE TABLE IF NOT EXISTS `add_resource` (
  ...
  `projectDescription` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `subfolder` varchar(8) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `username` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `organization` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `alt_lang_names` (
  ...
  `alt_lang_name` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `api_users` (
  ...
  `organization` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `buy` (
  ...
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `organization` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `buy_what` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `CellPhone` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `Cell_Phone_Title` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Cell_Phone_File` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `optional` varchar(160) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `countries` (
  ...
  `English` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Spanish` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Portuguese` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `French` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Dutch` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `German` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Chinese` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
--
-- Table structure for table `GRN_Lang_No`
--

DROP TABLE IF EXISTS `GRN_Lang_No`;
CREATE TABLE IF NOT EXISTS `GRN_Lang_No` (
  `GRN_Lang_No_Index` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `GRN_ROD_Code` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `GRN_Similar` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `GRN_Lang_No` varchar(50) DEFAULT NULL,
  `Facebook` varchar(100) DEFAULT NULL,
  `GRN_Language` varchar(60) DEFAULT NULL,
  `GRN_Par` varchar(70) DEFAULT NULL,
  `Language` varchar(50) NOT NULL,
  `used` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`GRN_Lang_No_Index`)
...
CREATE TABLE IF NOT EXISTS `ISO_Lang_Countries` (
  ...
  `LanguageName` varchar(75) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  KEY `ISO` (`ISO`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE IF NOT EXISTS `links` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `company` varchar(70) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `company_title` varchar(140) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `LN_Chinese` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `LN_Chinese` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LN_Dutch` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `LN_Dutch` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LN_English` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `LN_English` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LN_French` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `LN_French` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LN_German` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `LN_German` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LN_Portuguese` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `LN_Portuguese` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LN_Spanish` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `LN_Spanish` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `NT_Audio_Media` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `NT_Audio_Book` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `NT_Audio_Filename` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `NT_Audio_Chapter` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `NT_PDF_Media` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `NT_PDF` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `NT_PDF_Filename` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `OT_Audio_Media` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `OT_Audio_Book` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `OT_Audio_Filename` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `OT_Audio_Chapter` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `OT_PDF_Media` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `OT_PDF` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `OT_PDF_Filename` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PlaylistAudio` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `PlaylistAudioTitle` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `PlaylistAudioFilename` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PlaylistVideo` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `PlaylistVideoTitle` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `PlaylistVideoFilename` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `study` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `ScriptureDescription` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Testament` varchar(30) NOT NULL DEFAULT 'New Testament',
  `alphabet` varchar(30) NOT NULL DEFAULT 'Standand alphabet',
  `ScriptureURL` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `statement` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `Variants` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `Variant_Description` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Variant_Eng` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Variant_Spa` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Variant_Por` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Variant_Fre` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Variant_Dut` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Variant_Ger` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Variant_Chi` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `viewer` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) NOT NULL,
  `viewer_ROD_Variant` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `watch` (
  ...
  `Variant_Code` varchar(1) NOT NULL,
  `ISO_ROD_index` int(11) DEFAULT NULL,
  `organization` varchar(70) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `watch_what` varchar(140) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
