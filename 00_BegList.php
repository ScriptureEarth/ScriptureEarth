<?php
// called by 00-CountryTable.inc.php in AJAX
...
// CANNOT use $_SESSION because it is AJAX!
...
function check_input($value) {							// used for ' and " that find it in the input to \' and \"
	...
	$GN = $_GET['gn'];								// get country code [MX, etc] or 'ALL'
	$GN = preg_replace('/^([a-zA-Z]{1,3})/', "$1", $GN);
	$number = $_GET['n'];							// either number = 2 (Language Name) or 1 (Language Code)
