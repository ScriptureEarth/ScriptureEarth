...
<body>
	...
	switch ($CTPHC) {
		...
		?>
			...
			<p>Сайт <em>ScriptureEarth.org</em> находится под управлением SIL International. SIL работает с общинами этнолингвистических меньшинств, руководствуясь убеждением, что все люди созданы по образу и подобию Божьему, а языки и культуры являются частью богатства Божьего творения.</p>
		...
		?>
			...
			<h2>Соглашения</h2>
			<p>Добро пожаловать на наш сайт. Если вы продолжаете просматривать и использовать этот сайт, вы соглашаетесь соблюдать и быть связанными следующими условиями использования, которые вместе с нашей политикой конфиденциальности регулируют отношения SIL International с вами в отношении этого сайта. Если вы не согласны с какой-либо частью этих условий и положений, пожалуйста, не пользуйтесь нашим сайтом.</p>
			<p>Термин «SIL International» или «мы» или «нас» относится к владельцу веб-сайта, зарегистрированный офис которого находится по адресу 7500 West Camp Wisdom Road, Dallas TX.</p>
		...
		?>
			...
			<p>Когда вы просматриваете этот сайт или связываетесь с SIL International через этот сайт, мы не будем собирать о вас личную информацию, если вы не предоставите ее добровольно. Если вы укажете свой почтовый адрес или адрес электронной почты, вы получите только ту информацию, для которой вы указали этот адрес.</p>
			<p>При необходимости личная информация может быть передана организациям-партнерам SIL International для предоставления ответа на ваш запрос или комментарий.</p>
			<p>Если вы предоставляете непубличную личную информацию (например, имя, адрес, адрес электронной почты или номер телефона) через этот сайт, SIL International будет использовать такую информацию только в целях, указанных на странице, где она была собрана.</p>
			<p>SIL International не рассылает незапрашиваемую или «спамную» электронную почту и не продает, не сдает в аренду и не обменивает свои списки адресов электронной почты третьим лицам.</p>
			...
			<h3>Ссылки</h3>
			<p>ScriptureEarth содержит ссылки на другие веб-сайты. По этим ссылкам вы можете найти соответствующие ресурсы. Ссылка на документ или сайт не обязательно означает, что SIL International:</p>
			<ul>
			...
			<p>SIL International также не несет ответственности за политику конфиденциальности или практику этих сайтов.</p>
	<?php
			break;
